...
<body class="m-0 font-sans antialiased font-normal bg-white text-start text-base leading-default text-slate-500">
    ...
    <nav
        ...
        <div class="container flex items-center justify-between py-0 flex-wrap-inherit">
            <a class="uppercase text-sm mr-4 ml-4 whitespace-nowrap flex items-center justify-start gap-1 font-bold bg-white pr-2 rounded-lg text-slate-700 lg:ml-0" href="../pages/dashboard.html"> <img src="{{ asset('assets/1.png') }}" class="shadow rounded-full w-14 h-14" alt=""> Coding Coding Club </a>
            ...
            <div navbar-menu
                class="items-center mt-2 transition-all ease-soft duration-350 lg-max:bg-white lg-max:max-h-0 lg-max:overflow-hidden basis-full rounded-xl lg:flex lg:basis-auto">
                <ul class="flex flex-row p-2 mx-auto mb-0 list-none lg:flex-row xl:ml-auto">
                    <li class="flex items-center">
                      <a
                        class="leading-pro ease-soft-in md:text-white text-slate-700 md:border-white border-slate-700 text-xs tracking-tight-soft bg-150 bg-x-25 rounded-3.5xl hover:border-white hover:scale-102 hover:text-white active:hover:border-white active:hover:scale-102 active:hover:text-white active:opacity-85 active:shadow-soft-xs active:bg-white active:border-white mr-2 mb-0 inline-block cursor-pointer border border-solid bg-transparent py-2 px-8 text-center align-middle font-bold uppercase shadow-none transition-all hover:bg-transparent hover:opacity-75 hover:shadow-none active:scale-100 active:text-white active:hover:bg-transparent active:hover:opacity-75 active:hover:shadow-none"
                        href="{{ url('sign-up') }}"
                        >Sign Up</a
                      >
                    </li>
    ...
    <main class="mt-0 transition-all duration-200 ease-soft-in-out">
        <section class="min-h-screen mb-32">
            <div class="relative flex items-start pt-12 pb-56 m-4 overflow-hidden bg-center bg-cover min-h-50-screen rounded-xl"
                style="background-image: url({{ asset('assets/img/auth/curved14.jpg') }})">
                <span
                    ...
                    <div class="w-full max-w-full px-3 mx-auto mt-0 md:flex-0 shrink-0 md:w-7/12 lg:w-5/12 xl:w-4/12">
                        <div
                            ...
                            <div class="p-6 mb-0 text-center bg-white border-b-0 rounded-t-2xl">
                                <h5>Sign Up dengan</h5>
                            </div>
                            <div class="flex justify-center items-center flex-wrap px-3 -mx-3 sm:px-6 xl:px-12">
                                ...
                                <div class="w-full max-w-full px-1 mr-auto flex-0">
                                    <a class="inline-block w-full px-6 py-3 mb-4 font-bold text-center text-gray-200 uppercase align-middle transition-all bg-transparent border border-gray-200 border-solid rounded-lg shadow-none cursor-pointer hover:scale-102 leading-pro text-xs ease-soft-in tracking-tight-soft bg-150 bg-x-25 hover:bg-transparent hover:opacity-75"
                                        href="javascript:;">
                                        <svg width="24px" height="32px" viewBox="0 0 64 64" version="1.1"
                                            xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div class="flex-auto p-6">
                                <form role="form text-left" action="{{ route('signUp-process') }}" method="post">
                                    @csrf
                                    @if ($errors->any())
                                    ...
                                    <div class="mb-4">
                                        <input type="text"
                                            ...
                                            value="{{ old('name') }}" aria-describedby="name-addon" />
                                    </div>
                                    <div class="mb-4">
                                        <input type="text"
                                            class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                            placeholder="Nisn" aria-label="nisn" name="nisn"
                                            value="{{ old('nisn') }}" aria-describedby="nisn-addon" />
                                    </div>
                                    <div class="mb-4">
                                        <input type="text"
                                            class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
                                            placeholder="Telephone" aria-label="phone" name="phone"
                                            value="{{ old('phone') }}" aria-describedby="phone-addon" />
                                    </div>
                                    <div class="mb-4">
                                        <div class="relative">
                                    ...
                                    <div class="mb-4">
                                        <input type="username"
                                            ...
                                            value="{{ old('username') }}" aria-describedby="username-addon" />
                                    </div>
                                    <div class="">
                                        <input type="password"
                                            class="text-sm focus:shadow-soft-primary-outline leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding py-2 px-3 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:bg-white focus:text-gray-700 focus:outline-none focus:transition-shadow"
